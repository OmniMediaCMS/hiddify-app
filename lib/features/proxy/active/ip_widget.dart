...
const Map<String, OrgIconData> organizationData = {
  ...
  "azure": OrgIconData(Icons.cloud_rounded, Colors.blue),
  "amazon": OrgIconData(Icons.cloud_rounded, Colors.orange),
  "oracle": OrgIconData(Icons.cloud_rounded, Colors.red),
