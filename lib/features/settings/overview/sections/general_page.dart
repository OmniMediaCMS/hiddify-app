        ...
        children: [
          ...
          if (PlatformUtils.isAndroid) ...[
            ...
            SwitchListTile.adaptive(
              ...
              subtitle: const Text('Route selected application traffic through Tor after the current proxy node'),
              secondary: const Icon(Icons.security_rounded),
              value: ref.watch(Preferences.torEnabled),
              onChanged: ref.read(Preferences.torEnabled.notifier).update,
            ),
            ChoicePreferenceWidget(
              selected: ref.watch(Preferences.torBridgeMode),
              preferences: ref.watch(Preferences.torBridgeMode.notifier),
              choices: TorBridgeMode.values,
              title: 'Tor bridge mode',
              icon: Icons.hub_rounded,
              presentChoice: (value) => value.label,
            ),
            SwitchListTile.adaptive(
              title: const Text('Use custom Tor bridges'),
              subtitle: const Text('Custom bridges take priority over built-in bridges'),
              secondary: const Icon(Icons.account_tree_rounded),
              value: ref.watch(Preferences.torCustomBridgesEnabled),
              onChanged: ref.read(Preferences.torCustomBridgesEnabled.notifier).update,
            ),
            ValuePreferenceWidget(
              value: ref.watch(Preferences.torCustomBridges),
