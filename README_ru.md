...
Кроссплатформенный прокси-клиент на основе ядра [Sing-box](https://github.com/SagerNet/sing-box). Hiddify предлагает широкий спектр возможностей, таких как автоматический выбор узла, режим TUN, удалённые конфигурации (подписки). На Android Hiddify также поддерживает маршрутизацию выбранного трафика через Tor, bridge-режимы и пользовательские Tor bridges. Приложение с открытым исходным кодом, без рекламы. Поддерживая широкий спектр протоколов, мы обеспечиваем безопасный и конфиденциальный доступ к свободному интернету.
...
🧅 Поддержка Tor на Android: Direct, obfs4, Snowflake, meek и пользовательские bridges
